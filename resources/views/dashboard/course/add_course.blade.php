                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('add.course') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea id="elm1" name="course_description" class="form-control" maxlength="225" rows="3"> {{ old('course_description')}}
                                    </textarea>
                            ...
                            <input type="submit" value="Add Course" class="btn btn-info waves-effect waves-light" />
